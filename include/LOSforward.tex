...
\section{\bf Appendix A: Implementing the two-halo term}
\label{app:A}
...
\section{\bf Appendix B:The Born approximation in substructure lensing}
\label{app:B}
...
\section{\bf Appendix C: A fast algorithm for multi-plane lensing computations}
\label{app:C}
\begin{figure}
	\centering
