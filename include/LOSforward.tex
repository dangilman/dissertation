...
\begin{figure}
	...
	\caption[Joint distribution of mock lens and source redshifts]{\label{fig:zlenszsrc} The lens and source redshifts for the 50 quads in our mock lens sample. We draw these parameters, along with the lens velocity dispersion, ellipticity, and shear from the distributions used by \cite{OguriMarshall10}. }
\end{figure}	
